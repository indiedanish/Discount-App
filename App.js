      ...
      <Modal animationType="fade" transparent={true} visible={modalVisible}>
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Text
              style={{ color: "#E74C3C", marginTop: 10, fontFamily: "Raleway" }}
            >
            ...
            >
              ...
              >
                <Text style={{ color: "white", fontFamily: "Raleway" }}>
                  Yes
                </Text>
              </TouchableOpacity>
        ...
        >
          <DataTable>
            <DataTable.Header style={{ borderWidth: 0.5 }}>
              <DataTable.Cell>
                {" "}
                <Text style={{ fontFamily: "Raleway" }}> Original</Text>{" "}
              </DataTable.Cell>
              <DataTable.Cell>
                {" "}
                <Text style={{ fontFamily: "Raleway" }}> Discount </Text>
              </DataTable.Cell>
              <DataTable.Cell>
                {" "}
                <Text style={{ fontFamily: "Raleway" }}> Final Price </Text>
              </DataTable.Cell>
            </DataTable.Header>
              ...
              renderItem={({ item, index }) => {
                if (item != undefined) {
                  return (
                    <TouchableOpacity
                      onPress={() => {
                        setToDelete(index), setModalVisible(true);
                      }}
                    >
                      <DataTable.Row>
                        ...
                        <DataTable.Cell style={{ marginRight: 70 }} numeric>
                          {" "}
                          <Text style={{ fontFamily: "Raleway" }}>
                            {item.Discount.discount}%{" "}
                          </Text>
                        </DataTable.Cell>
                        <DataTable.Cell style={{ marginRight: 65 }} numeric>
                          {" "}
                          <Text style={{ fontFamily: "Raleway" }}>
                            Rs {item.DiscountedPrice.discountedPrice}{" "}
                          </Text>
                        </DataTable.Cell>
                      </DataTable.Row>
                    </TouchableOpacity>
